...
import backgroundCover from "../assets/img/background-User.png";
import Waller from "../assets/img/Profile/wallet.png";
import Tree from "../assets/img/Profile/Tree.svg";
import Near from "../assets/img/Profile/nearWallet.png";
import Petra from "../assets/img/Profile/petra.png";
import Google from "../assets/img/Profile/google.svg";
import Solana from "../assets/img/Profile/solana-sol-logo.png";
import Acti from "../assets/img/Profile/eded.svg";
import Contribute from "../components/ProfilePage/Contribute";
import Noti from "../components/ProfilePage/Noti";
import Pikachu from "../assets/img/Profile/deleteGif.gif";
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const contri = document.querySelector(".contri1");
  ...
  return (
    <>
      ...
      <div className="not-for-Ipad not-for-phone">
        <header
          className="row"
          style={{
                        ...
                        <div>
                          ...
                          >
                            <img
                              ...
                              src="https://th.bing.com/th?id=OSK.836c269b16772a5abcee77c5311aa82c&w=188&h=132&c=7&o=6&oif=webp&dpr=1.1&pid=SANGAM"
                              alt="profile"
                              style={{
                                width: "120px",
                                height: "120px",
            ...
            <div className="row" style={{ marginBottom: "12px" }}>
              ...
              >
                <div className="row">
                  ...
                  >
                    <div className="col-lg-12">
                      <div style={{ marginLeft: "152px", marginBottom:"40px" }}>
                        <span className="User-name">{profileUserName}</span>
                        <div>
                          <div
                            style={{
            ...
            <div className="row">
              ...
              <div className="col-lg-12" style={{ padding: "0" }}>
                ...
                >
                  ...
                  >
                    <div
                      className="profile-acti-part contri1 "
                      onClick={() => {
                        setNews("contri");
                      }}
                    >
                    ...
                    <div
                      className="profile-acti-part post1"
                      onClick={() => {
                        setNews("post");
                      }}
                    >
