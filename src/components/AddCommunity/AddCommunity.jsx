...
import proposalIcon from "../../assets/Communities/proposal-icon.svg";
import discussionIcon from "../../assets/Communities/discussion-icon.svg";
import k from "../../assets/Communities/k.jpg";
...
const AddCommunity = () => {
  ...
  return (
    <body1 className="addcommunity-pageeeeeee">
      <div className="addcommunity-first backgroundfilter"></div>
      ...
      <div className="addcommunity-create row">
        <div className="addcommunity-create1 col-lg-6">
          ...
          <div className="addcommunity-create1-info">
            ...
            members to your DAOs. I highly recommend checking it out if you are
            a DAO admin or considering launching a DAO.
      ...
      <div className="addcommunity-create row">
        ...
        <div className="addcommunity-create2 col-lg-6">
          <div className="addcommunity-create2-wrap">
            <div className="addcommunity-create2-wrap-column">
              <div className="addcommunity-create2-wrap-column-number">2</div>
              <div className="addcommunity-create2-wrap-column-line"></div>
            </div>
            <div className="addcommunity-create2-wrap-content-page2">
              <div className="addcommunity-create2-wrap-content-heading">
                STEP 2/3
                <div className="addcommunity-create2-wrap-content-heading1">
                  Choose modules
              ...
              <div className="addcommunity-create2-wrap-content-body1-2">
                ✅ Recommendation based on your community type
              </div>

              <div className="addcommunity-create2-wrap-content-body2-2">
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  <div className="addcommunity-create2-wrap-content-body2-2-module-icon">
                    💬
                  </div>
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Discussions
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      For topic specific communication amongst your community
                      members
                    </div>
                  </div>
                  <label className="addcommunity-create2-wrap-content-body2-2-module-switch-btn">
                    <input type="checkbox" />
                    <span className="addcommunity-create2-wrap-content-body2-2-module-switch-btn-slider" />
                  </label>
                </div>
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  ...
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Proposals
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      Create, discuss, and vote on proposals with in-app
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  ...
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Events
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      Hub for tracking organising all your events
                    </div>
                  </div>
                  <label className="addcommunity-create2-wrap-content-body2-2-module-switch-btn">
                    <input type="checkbox" />
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  ...
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Spaces
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      Exchange ideas on various topics in dedicated channels
                    </div>
                  </div>
                  <label className="addcommunity-create2-wrap-content-body2-2-module-switch-btn">
                    <input type="checkbox" />
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module-other">
                  Other modules
                </div>
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  ...
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Courses
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      Create lessons and quizzes for your community
                    </div>
                  </div>
                  <label className="addcommunity-create2-wrap-content-body2-2-module-switch-btn">
                    <input type="checkbox" />
                ...
                <div className="addcommunity-create2-wrap-content-body2-2-module">
                  ...
                  <div className="addcommunity-create2-wrap-content-body2-2-module-content">
                    Documents
                    <div className="addcommunity-create2-wrap-content-body2-2-module-subcontent">
                      A resource repository including relevant documents
                    </div>
                  </div>
                  <label className="addcommunity-create2-wrap-content-body2-2-module-switch-btn">
                    <input type="checkbox" />
      ...
      <div className="addcommunity-create row">
        <div className="addcommunity-create1 col-lg-6">
          ...
          <div className="addcommunity-create1-wrap-avt-body3-1">
            <div className="addcommunity-create1-wrap-avt-body3-1-circle1">
              <div className="addcommunity-create1-wrap-avt-body3-1-circle2"></div>
            </div>
          </div>
          <div
            className="addcommunity-create1-wrap-avt-body3-1-circle-avt"
            style={{ backgroundImage: `url(${addCommunityImg})` }}
          >
            <h5 className="addcommunity-create1-wrap-avt-body3-1-circle-avt-name">
              K
            </h5>
          </div>
        </div>
        ...
        <div className="addcommunity-create2 col-lg-6">
          <div className="addcommunity-create2-wrap">
            <div className="addcommunity-create2-wrap-column">
              <div className="addcommunity-create2-wrap-column-number">3</div>
              <div className="addcommunity-create2-wrap-column-line"></div>
            </div>
            <div className="addcommunity-create2-wrap-content-page2">
              <div className="addcommunity-create2-wrap-content-heading">
              ...
              <div className="addcommunity-create2-wrap-content-body3-2">
                <div className="addcommunity-create2-wrap-content-body3-2-contents">
                  <div className="addcommunity-create2-wrap-content-body3-2-content">
                    <div className="addcommunity-create2-wrap-content-body3-2-content-icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
                    ...
                    <div className="addcommunity-create2-wrap-content-body3-2-content-text">
                      Discord
                      <div className="addcommunity-create2-wrap-content-body3-2-content-subtext">
                        Import roles and create discord based bounties
                      </div>
                    </div>

                    <button className="addcommunity-create2-wrap-content-body3-2-content-btn">
                      Connect
                    </button>
                  </div>
                  ...
                  <div className="addcommunity-create2-wrap-content-body3-2-content">
                    ...
                    <div className="addcommunity-create2-wrap-content-body3-2-content-text">
                      Discourse
                      <span className="addcommunity-create2-wrap-content-body3-2-content-text-new">
                        NEW
                      </span>
                      <div className="addcommunity-create2-wrap-content-body3-2-content-subtext">
                  ...
                  <div className="addcommunity-create2-wrap-content-body3-2-content-other">
                    NOTIFICATIONS
                  </div>
                  ...
                  <div className="addcommunity-create2-wrap-content-body3-2-content">
                    ...
                    <div className="addcommunity-create2-wrap-content-body3-2-content-text">
                      ...
                      <div className="addcommunity-create2-wrap-content-body3-2-content-subtext">
                        Get notified on a dedicated channel for your activities
                        here
                      </div>
                    </div>
          ...
          <div className="addcommunity-create2-bottom-body3">
            <button
              className="addcommunity-create2-bottom-btn"
              style={{
            ...
            >
              <div className="addcommunity-create2-bottom-btn1-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
