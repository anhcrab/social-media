...
export default function L_body() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const scrolled3 = window.scrollY / (docHeight + window.innerHeight) - 4;
      console.log("scroll3= " + scrolled3);

      if (scrolled3 >= 3.4 && scrolled3 <= 4) {
        const box1 = document.getElementById("tn-box1");
        const transformValue = "scale(" + scrolled3 * (scrolled3 - 1.8) + ")";
      ...
      } else if (scrolled3 > 4 && scrolled3 <= 6.4) {
        const box1 = document.getElementById("tn-box1");
        const transformValue = "scale(" + scrolled3 * scrolled3 + ")";
        box1.style.WebkitTransform = transformValue;
        box1.style.MozTransform = transformValue;
        box1.style.OTransform = transformValue;
        box1.style.transform = transformValue;
      } else if (scrolled3 > 6.4 && scrolled3 <= 7) {
        scrolled4 -= x;
        console.log("scroll4= " + scrolled4);
        const box1 = document.getElementById("tn-box1");
        box1.classList.add(".tn-box2");
        const transformValue = "scale(" + scrolled4 + ")";
        box1.style.WebkitTransform = transformValue;
        box1.style.MozTransform = transformValue;
        box1.style.OTransform = transformValue;
        box1.style.transform = transformValue;
  ...
  return (
    <body>
      <L_header className="tn-z-index" />
      <L_body1 />
      {/* Big img part */}
      <div className="row" data-aos="fade-up" data-aos-duration="3000" href="#">
        <div className="col-1"></div>
        <div className="col-10 tn-img-container">
          <img className="tn-mac1" src={mac} alt="" />
          <img className="tn-big-img" src={big} alt="" />
          <img className="tn-mobile-img" src={mobile} alt="" />
          <p className="tn-trust-text">Trusted by leading communities</p>
          <div className="tn-commu">
            <img className="tn-commu1" src={commu1} alt="" />

            <img className="tn-commu2" src={commu2} alt="" />

            <img className="tn-commu3" src={commu3} alt="" />

            <img className="tn-commu4" src={commu4} alt="" />
          </div>
          <div className="tn-please">
            <img className="tn-please-icon" src={please} alt="" />
          </div>
          <p className="tn-work-text">How it works in 3 steps</p>
        </div>
        <div className="col-1"></div>
      </div>
      {/* Big img part */}
      ...
      <div className="row" data-aos="fade-up" data-aos-duration="3000">
        <div className="col-1"></div>
        <div className="col-10 tn-img-container">
          <div className="row tn-hover-part">
            <div className="col-4 tn-hover-part-contain1">
              <span className="tn-hover-part-num">01</span>
              <p className="tn-hover-part-title">
                Join or Claim your Workspace
              </p>
              <p className="tn-hover-part-body">
          ...
          <div className="tn-support">
            <div className="tn-please">
              <img className="tn-please-icon" src={please} alt="" />
            </div>
            <p
              className="tn-support-text"
              data-aos="fade-up"
          ...
          <div
            className="tn-coin-icon"
            data-aos="fade-up"
            data-aos-duration="3000"
          >
            <img className="tn-coin-icon-s" src={ethereum} alt="" />
            <img className="tn-coin-icon-d-1" src={polygon} alt="" />
            <img className="tn-coin-icon-s" src={solana} alt="" />
            <img className="tn-coin-icon-d" src={aptos} alt="" />
            <img className="tn-coin-icon-s" src={gnosis} alt="" />
          </div>
        </div>
      ...
      <div className="row tn-color-container">
        ...
        <div className="col-10" data-aos="fade-up" data-aos-duration="3000">
          <div className="tn-color-container-header">
            <img className="tn-vector" src={vector} alt="" />
            <img className="tn-underline" src={yellow} alt="" />
            <p className="tn-diff-text">What makes DAO Manager Different</p>
          </div>
        </div>
        <div className="col-1"></div>
        <div
          className="col-6 tn-text-mess"
          data-aos="fade-up"
          data-aos-duration="3000"
        >
          <img className="tn-gif" src={gif} alt="" />
        </div>
        <div
          className="col-6 tn-text-mess"
          data-aos="fade-up"
        ...
        >
          ...
          <p className="tn-pc-title">AI Assisted Community Management</p>

          <p className="tn-pc-text">
          ...
          <button className="tn-read-more">Read More</button>
        </div>
        <div
          className="col-6 tn-text-mess"
          data-aos="fade-up"
        ...
        >
          ...
          <p className="tn-group-title">GATING based on everything!</p>
          <p className="tn-group-text">
        ...
        <div
          ...
          data-aos-duration="3000"
        >
          <img className="tn-group-img" src={gate} alt="" />
        </div>
        <div
          className="col-6 tn-text-mess"
          data-aos="fade-up"
          data-aos-duration="3000"
        >
          <img className="tn-bounties" src={bounties} alt="" />
        </div>
        <div
          className="col-6 tn-text-mess"
          data-aos="fade-up"
        ...
        >
          ...
          <p className="tn-link-title">LINKED bounties, proposals and voting</p>
          <p className="tn-pc-text">
        ...
        <div className="row" data-aos="fade-up" data-aos-duration="3000">
          <div className="col-6 tn-text-mess">
            <img className="tn-hour" src={hour} alt="" />
            <p className="tn-hour-title">Review, Pay & Reward</p>
            <p className="tn-hour-text">
          ...
          <div className="col-6">
            <img className="tn-iphone-p" src={iphone} alt="" />
          </div>
        </div>
      </div>
      {/* Tree part */}
      ...
      {/* glass part */}
      <div
        className="tn-glass-part"
        data-aos="fade-up"
        data-aos-duration="3000"
      >
        <div>
          <img className="tn-glass-icon" src={glass} alt="" />
        </div>
        <p className="tn-way-text">Manage your contributors, your way</p>
        <div>
          <img className="tn-way-under" src={under} alt="" />
        </div>
        <L_body23 />
      </div>
      {/* glass part */}
